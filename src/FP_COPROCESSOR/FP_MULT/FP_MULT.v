...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone IV GX" EXCEPTION_HANDLING="NO" PIPELINE=11 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 clock dataa datab nan overflow result underflow zero
...
module  FP_MULT_altfp_mult_bnq
	...
	assign
		...
		zero = zero_ff;
endmodule //FP_MULT_altfp_mult_bnq
//VALID FILE
...
module FP_MULT (
	...
	FP_MULT_altfp_mult_bnq	FP_MULT_altfp_mult_bnq_component (
				.clock (clock),
				.datab (datab),
				.dataa (dataa),
				.overflow (sub_wire0),
